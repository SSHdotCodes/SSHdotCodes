...
const result = spawnSync('ffmpeg', [
  ...
  '-loop', '0', 'assets/workstation.gif'
], { stdio: 'inherit' });
if (result.status !== 0) throw new Error('ffmpeg failed; install ffmpeg and retry.');
await copyFile('.render/frames/0000.png', 'assets/workstation.png');
console.log('Wrote assets/workstation.gif and assets/workstation.png');
